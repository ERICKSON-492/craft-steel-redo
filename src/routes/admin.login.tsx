    ...
    <div className="grid min-h-screen place-items-center bg-slate-50 p-6">
      <div className="max-w-md rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-600">
          You're signed in as <strong>{email}</strong>, but this account does not have admin access.
        </p>
        <button onClick={() => signOut()} className="mt-4 text-sm font-semibold text-slate-900 underline">
          Sign out
        </button>
        <div className="mt-4">
